namespace MiniExcelLibs.Utils
{
    ...
    internal class ImageHelper
    {
        ...
        public static ImageFormat GetImageFormat(byte[] bytes)
        {
            byte[] bmp = stackalloc byte[] { (byte)'B', (byte)'M' };            // BMP
            byte[] gif = stackalloc byte[] { (byte)'G', (byte)'I', (byte)'F' }; // GIF
            byte[] png = stackalloc byte[] { 137, 80, 78, 71 };                 // PNG
            byte[] tiff = stackalloc byte[] { 73, 73, 42 };                     // TIFF
            byte[] tiff2 = stackalloc byte[] { 77, 77, 42 };                    // TIFF
            byte[] jpeg = stackalloc byte[] { 255, 216, 255, 224 };             // jpeg
            byte[] jpeg2 = stackalloc byte[] { 255, 216, 255, 225 };            // jpeg canon
