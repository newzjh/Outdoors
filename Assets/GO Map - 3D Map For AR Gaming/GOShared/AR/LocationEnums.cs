    ...
    public static class LocationEnums
    {
        ...
        public static Coordinates GetCoordinates(DemoLocation demoLocation)
        {
            ...
            switch (demoLocation)
            {
                ...
                case DemoLocation.GuangZhou:
                    return new Coordinates(23.13161, 113.31912, 0);
                case DemoLocation.ShenZhen:
                    return new Coordinates(22.51728, 113.94333, 0);
                case DemoLocation.HongKong:
                    return new Coordinates(22.25932, 114.23846, 0);
