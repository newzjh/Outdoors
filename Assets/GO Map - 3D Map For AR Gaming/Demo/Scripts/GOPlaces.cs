...
namespace GoMap
{
	...
	public class GOPlaces : MonoBehaviour {
		...
		async void OnLoadTile (GOTile tile) {
			await NearbySearch(tile);
		}

		async UniTask NearbySearch (GOTile tile) {
			...
			if (string.IsNullOrEmpty (www.error)) {
				...
				string response = GetTextFromData(www.downloadHandler.data);
