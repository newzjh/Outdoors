...
namespace GoMap
{
    ...
    public class GOFeature
    {
        ...
        public virtual async UniTask BuildFeature(GOTile tile, bool delayedLoad)
        {
        ...
        public virtual async UniTask CreateLine(GOTile tile, bool delayedLoad)
        {
            //if ()
            ...
            if ((goTile.mapType == GOMap.GOMapType.Nextzen || goTile.mapType == GOMap.GOMapType.Mapbox) && layer != null && layer.layerType == GOLayer.GOLayerType.Roads && name != null && name.Length > 0 && goTile.useStreetnames && !isLoop && !goTile.useElevation)
            {
                ...
                await streetName.Build(name, this);
            }
        ...
        public virtual async UniTask CreatePolygon(GOTile tile, bool delayedLoad)
        {
        ...
        async UniTask CreatePoi(GOTile tile, bool delayedLoad)
        {
        ...
        async UniTask CreateLabel(GOTile tile, bool delayedLoad)
        {
